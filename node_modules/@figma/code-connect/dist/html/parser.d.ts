 ...
 */
export declare function parseExampleTemplate(exp: ts.ArrowFunction, parserContext: ParserContext, propMappings?: PropMappings, skipTemplateHelpers?: boolean): {
    code: string;
    nestable: boolean;
};
export declare function parseHtmlDoc(node: ts.CallExpression, parserContext: ParserContext, { skipTemplateHelpers }: ParseOptions): Promise<CodeConnectJSON>;
